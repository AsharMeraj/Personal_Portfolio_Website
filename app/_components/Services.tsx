...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, head, para }) => {
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="flex gap-8 flex-col rotateDiv"
    >
...
const Services = () => {
  return (
    <section id="about" className="grid px-6 md:px-10 place-items-center relative py-24 md:py-40 overflow-hidden">
          {/* Background Texture */}
          ...
          <div className="max-w-7xl mx-auto flex gap-16 md:gap-24 flex-col lg:flex-row z-20 items-start">
            ...
            <div className="grid sm:grid-cols-2 gap-20 lg:gap-x-16 lg:gap-y-24">
              <ServiceCard 
